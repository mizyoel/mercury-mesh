...
- Restore conditional VS Code `runSubagent` support for surfaces that expose real named agents, while retaining inline execution for coordinator-only installs.
