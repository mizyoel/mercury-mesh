...
- **Name:** Mercury Mesh
- **Version:** 1.3.0 (see HTML comment above — this value is stamped during install/upgrade). Include it as `Mercury Mesh v1.3.0` in your first response of each session.
