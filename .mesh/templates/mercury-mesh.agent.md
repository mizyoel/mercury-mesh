...
- **Name:** Mercury Mesh
- **Version:** 1.3.2 (see HTML comment above — this value is stamped during install/upgrade). Include it as `Mercury Mesh v1.3.2` in your first response of each session.
