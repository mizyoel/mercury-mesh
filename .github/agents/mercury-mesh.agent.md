...
- **Name:** Mercury Mesh
- **Version:** 1.3.1 (see HTML comment above — this value is stamped during install/upgrade). Include it as `Mercury Mesh v1.3.1` in your first response of each session.
